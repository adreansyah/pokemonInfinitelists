...
const Detail = () => {
    ...
    const { loading, error, data: { pokemon = null } = {} } = useQuery(POKEMON_QUERY, {
        variables: { name },
    })
                ...
                <Container>
                    {pokemon && (
                        <Card>
                            ...
                            <Divider />
                            <PokemonAttackInfo fast={pokemon.attacks.fast} special={pokemon.attacks.special} />
                            <Divider />
                            <PokemonEvoInfo evolutions={pokemon.evolutions} requirement={pokemon.evolutionRequirements} />
                        </Card>
                    )}
                </Container>
            </Box>
